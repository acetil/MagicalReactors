...
public class MachineBlocks {
    public static RegistryObject<BlockMachine> CENTRIFUGE = ModBlocks.BLOCKS.register("centrifuge", () ->
            new BlockMachine("centrifuge", Block.Properties.of(Material.STONE)));
    public static RegistryObject<BlockMachine> RECRYSTALISER = ModBlocks.BLOCKS.register("recrystaliser",
            () -> new BlockMachine("recrystaliser", Block.Properties.of(Material.STONE)));
    public static RegistryObject<BlockMachine> REACTOR_VESSEL = ModBlocks.BLOCKS.register("reactor_vessel",
            () -> new BlockMachine("reactor_vessel", Block.Properties.of(Material.STONE)));
    public static RegistryObject<BlockMachine> FERMENTER = ModBlocks.BLOCKS.register("fermenter",
            () -> new BlockMachine("fermenter", Block.Properties.of(Material.STONE)));
    public static RegistryObject<BlockMachine> CONDENSER = ModBlocks.BLOCKS.register("condenser",
            () -> new BlockMachine("condenser", Block.Properties.of(Material.STONE)));
    public static RegistryObject<BlockDistiller> DISTILLER = ModBlocks.BLOCKS.register("distiller",
            () -> new BlockDistiller("distiller", 2, Block.Properties.of(Material.STONE)));
    public static RegistryObject<BlockMachine> DISSOLVER = ModBlocks.BLOCKS.register("dissolver",
            () -> new BlockMachine("dissolver", Block.Properties.of(Material.STONE)));

    private static RegistryObject<Item> CENTRIFUGE_ITEM = ModBlocks.ITEMS.register("centrifuge", () -> new BlockItem(CENTRIFUGE.get(), new Item.Properties().tab(MagicalReactors.ITEM_GROUP)));
    private static RegistryObject<Item> RECRYSTALISER_ITEM = ModBlocks.ITEMS.register("recrystaliser", () -> new BlockItem(RECRYSTALISER.get(), new Item.Properties().tab(MagicalReactors.ITEM_GROUP)));
    private static RegistryObject<Item> REACTOR_VESSEL_ITEM = ModBlocks.ITEMS.register("reactor_vessel", () -> new BlockItem(REACTOR_VESSEL.get(), new Item.Properties().tab(MagicalReactors.ITEM_GROUP)));
    private static RegistryObject<Item> FERMENTER_ITEM = ModBlocks.ITEMS.register("fermenter", () -> new BlockItem(FERMENTER.get(), new Item.Properties().tab(MagicalReactors.ITEM_GROUP)));
    private static RegistryObject<Item> CONDENSER_ITEM = ModBlocks.ITEMS.register("condenser", () -> new BlockItem(CONDENSER.get(), new Item.Properties().tab(MagicalReactors.ITEM_GROUP)));
    private static RegistryObject<Item> DISTILLER_ITEM = ModBlocks.ITEMS.register("distiller", () -> new BlockItem(DISTILLER.get(), new Item.Properties().tab(MagicalReactors.ITEM_GROUP)));
    private static RegistryObject<Item> DISSOLVER_ITEM = ModBlocks.ITEMS.register("dissolver", () -> new BlockItem(DISSOLVER.get(), new Item.Properties().tab(MagicalReactors.ITEM_GROUP)));
